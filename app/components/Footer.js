...
const Footer = () => {
    return (
        <footer
            className='bg-white py-10 px-4 flex flex-col items-center mt-10'>
            {/* Inner container */}
            <div
                ...
                <div className='flex flex-col sm:flex-row justify-between items-center mt-10 gap-4 text-xs text-black px-2'>
                    ...
                    <div className='flex gap-4'>
                        <img src='./assets/in.svg' alt='LinkedIn' className='w-5 h-5' loading="lazy" />
                        <img src='./assets/x.svg' alt='X' className='w-5 h-5' loading="lazy" />
                    </div>
                </div>
            </div>
